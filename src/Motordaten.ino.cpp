# 1 "C:\\Users\\GERRYA~1\\AppData\\Local\\Temp\\tmpdvvjgxyz"
#include <Arduino.h>
...
# 352 "C:/Users/gerryadmin/Documents/Motordaten/src/Motordaten.ino"
void GetTemperature( void * parameter) {
  float tmp0 = 0;
  float tmp1 = 0;
  for (;;) {
...
# 421 "C:/Users/gerryadmin/Documents/Motordaten/src/Motordaten.ino"
void SendN2kDCStatus(double BatteryVoltage, double SoC, double BatCapacity) {
...
# 486 "C:/Users/gerryadmin/Documents/Motordaten/src/Motordaten.ino"
void SendN2kEngineData(double Oiltemp, double Coolanttemp, double rpm, double hours, double voltage) {
